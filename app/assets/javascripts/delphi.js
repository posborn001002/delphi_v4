...
*/
    ...
    var ntc = {
        ...
        name: function(color) {
            ...
            return (cl < 0 ? ["#000000", "Invalid Color: " + color, false] : { hex: "#" + ntc.names[cl][0], name: ntc.names[cl][1], diff: ntc.names[cl][2] });
        },
...
ntc.init();
    ...
    $('#color-btn').on( 'click', function() {
        for(var i = 0; i < ntc.palette.length; i++) {
            var color = '#' + ntc.palette[i];
            colorName = ntc.name( color )
           $('#color-output').append('<div style="width:100%">' +
               '<div class="palette" style="height:20px;width:20px;background-color:' + colorName.hex + ';border:solid 1px #FFFFFF;"></div>' +
               '<div class="palette2" style="height:20px;width:20px;background-color:' + color + ';border:solid 1px #FFFFFF;"></div>' +
               '<p style="width:800px;">' +
                    '<span style="margin-left: 25px;width:175px;font-size: 14px;white-space: nowrap;">|' + colorName.name + '</span>' +
                    '<span style="margin-left: 25px;width:175px;font-size: 14px;white-space: nowrap;">|' + colorName.hex + '</span>' +
                    '<span style="margin-left: 25px;width:175px;font-size: 14px;white-space: nowrap;">|' + colorName.diff + '</span>' +
                    '<span style="margin-left: 25px;width:175px;font-size: 14px;white-space: nowrap;">|' + color + '</span>' +
               '</p> ' +
                '</div>' );
        }
    })
